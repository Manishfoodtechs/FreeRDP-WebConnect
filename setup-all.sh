...
wget https://codeplexarchive.blob.core.windows.net/archive/projects/casablanca/casablanca.zip && unzip casablanca.zip  || { echo 'Unable to download casablanca from codeplex'; exit 99; }
